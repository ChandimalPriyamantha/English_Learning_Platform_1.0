...
<body class="my-login-page bg-light">
    <main>
        <section class="h-100">
                                    ...
                                    <div class="card shadow border">
                                        <div class="card-body d-flex flex-column align-items-center">
                                            <div class="card-body">
                                                ...
                                                <?php } ?>
                                                <!-- ======================== Display error message and success message  ================================== -->
                                                <form method="POST" action="check-php/check-register.php">
                                                    <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="address" value="">
